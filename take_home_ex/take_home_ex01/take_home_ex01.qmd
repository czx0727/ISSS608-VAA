...
1.  Gender: **ST004D01T**
    ...
    ![](images/Male or Females.PNG){width="248"}
...
2.  Socioeconomic Aspect
    ...
    ![](images/Sociaeconomic.PNG){width="364"}

3.  Expected Education Level: **EXPECEDU**

    ![](images/edu.PNG){width="425"}
...
Change to numercial values

Average of [plausible values](https://nces.ed.gov/nationsreportcard/tdw/analysis/est_pv_individual.aspx)
