...
The ridgeline plot below is plotted by using `geom_density_ridges()`. Please read more from [here](https://r4va.netlify.app/chap09#visualising-distribution-with-ridgeline-plot).
